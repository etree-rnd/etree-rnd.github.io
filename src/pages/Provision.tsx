      ...
      <>
        ...
        <div className={styles.t_box}>
          ...
          <span className={styles.contents}>
            이 약관은 넥스트리온이 운영하는 서비스의 회원가입과 서비스 이용에
        ...
        <div className={styles.t_box}>
          ...
          <ol className={styles.ol}>
            <li className={styles.ol_li}>
              <span className={styles.num}>①</span>'넥스트리온'이란 회사가
            ...
            <li className={styles.ol_li}>
              ...
              '넥스트리온'이 제공하는 서비스를 받는 회원과 비회원을 말합니다.
            </li>
            <li className={styles.ol_li}>
              <span className={styles.num}>③</span>'회원'이라 함은
              '넥스트리온'에 개인정보를 제공하여 회원등록을 한 자로서,
              '넥스트리온'의 정보를 지속적으로 제공받으며, '넥스트리온'이
              제공하는 서비스를 계속적으로 이용할 수 있는 자를 말합니다.
            </li>
            <li className={styles.ol_li}>
              <span className={styles.num}>④</span>'비회원'이라 함은 회원에
              가입하지 않고 '넥스트리온'이 제공하는 서비스를 이용하는 자를
              말합니다.
            </li>
          </ol>
        </div>
        <div className={styles.t_box}>
          ...
          <ol className={styles.ol}>
            <li className={styles.ol_li}>
              <span className={styles.num}>①</span>'넥스트리온'은 이 약관의
              내용과 상호, 연락처(전화, 팩스, 전자우편 주소 등) 등을 이용자가 알
              수 있도록 사이트 초기 서비스화면에 게시합니다.
            </li>
            <li className={styles.ol_li}>
              <span className={styles.num}>②</span>'넥스트리온'은
        ...
        <div className={styles.t_box}>
          ...
          <ol className={styles.ol}>
            <li className={styles.ol_li}>
              <span className={styles.num}>①</span>'넥스트리온'은 다음과 같은
              서비스를 제공합니다.
              <ol className={styles.ol}>
                <li className={styles.ol_li}>
            ...
            <li className={styles.ol_li}>
              <span className={styles.num}>②</span>'넥스트리온'은 재화의 품절
        ...
        <div className={styles.t_box}>
          ...
          <ol className={styles.ol}>
            <li className={styles.ol_li}>
              <span className={styles.num}>①</span>'넥스트리온' 이용자는
              '넥스트리온'이 정한 가입 양식에 따라 이 약관에 동의한다는 의사
              표시를 한 후 회원정보를 기입함으로서 회원가입을 신청합니다.
            </li>
            <li className={styles.ol_li}>
              <span className={styles.num}>②</span>'넥스트리온'은 제1항과 같이
        ...
        <div className={styles.t_box}>
          ...
          <ol className={styles.ol}>
            ...
            <li className={styles.ol_li}>
              ...
              해당하는 경우, '넥스트리온'은 회원자격을 제한 및 정지시킬 수
              있습니다.
              <ol className={styles.ol}>
                <li className={styles.ol_li}>
            ...
            <li className={styles.ol_li}>
              <span className={styles.num}>③</span>'넥스트리온' 회원 자격을
              제한,정지 시킨 후, 동일한 행위가 2회이상 반복되거나 30일이내에 그
              사유가 시정되지 아니하는 경우 '넥스트리온'은 회원자격을 상실시킬
              수 있습니다.
            </li>
            <li className={styles.ol_li}>
              <span className={styles.num}>④</span>'넥스트리온'이 회원자격을
        ...
        <div className={styles.t_box}>
          ...
          <ol className={styles.ol}>
            <li className={styles.ol_li}>
              <span className={styles.num}>①</span>'넥스트리온'이 회원에 대한
              통지를 하는 경우, 회원이 '넥스트리온'에게 제출한 전자우편 주소로
              할 수 있습니다.
            </li>
            <li className={styles.ol_li}>
              <span className={styles.num}>②</span>'넥스트리온'은 불특정다수
              회원에 대한 통지의 경우 1주일이상 '넥스트리온' 게시판에
        ...
        <div className={styles.t_box}>
          ...
          <ol className={styles.ol}>
            <li className={styles.ol_li}>
              <span className={styles.num}>①</span>'넥스트리온' 이용자는
              '넥스트리온'상에서 이하의 방법에 의하여 구매를 신청합니다.
              <ol className={styles.ol}>
                <li className={styles.ol_li}>
        ...
        <div className={styles.t_box}>
          ...
          <ol className={styles.ol}>
            ...
            <li className={styles.ol_li}>
              <span className={styles.num}>②</span>'넥스트리온' 승낙이 제12조
        ...
        <div className={styles.t_box}>
          ...
          <ol className={styles.ol}>
            <li className={styles.ol_li}>
              <span className={styles.num}>①</span>사이버캐시는 '넥스트리온'
        ...
        <div className={styles.t_box}>
          ...
          <ol className={styles.ol}>
            <li className={styles.ol_li}>
              <span className={styles.num}>①</span>'넥스트리온'은 이용자의
            ...
            <li className={styles.ol_li}>
              <span className={styles.num}>③</span>'넥스트리온'은 배송 전
        ...
        <div className={styles.t_box}>
          ...
          <ol className={styles.ol}>
            ...
            <li className={styles.ol_li}>
              <span className={styles.num}>②</span>'넥스트리온' 이용자의
            ...
            <li className={styles.ol_li}>
              ...
              모든 책임은 '넥스트리온'이 책임을 집니다. 다만, 다음의 경우에는
              예외로 합니다.
              <ol className={styles.ol}>
                <li className={styles.ol_li}>
            ...
            <li className={styles.ol_li}>
              <span className={styles.num}>④</span>'넥스트리온'이 제2항과
            ...
            <li className={styles.ol_li}>
              ...
              '넥스트리온'이 가지고 있는 자신의 개인정보에 대해 열람 및
              오류정정을 요구할 수 있으며 '넥스트리온'은 이에 대해 지체 없이
              필요한 조치를 취할 의무를 집니다. 이용자가 오류의 정정을 요구한
              경우에는 '넥스트리온'이 그 오류를 정정 할 때까지 당해 개인정보를
              이용하지 않습니다.
            </li>
            <li className={styles.ol_li}>
              <span className={styles.num}>⑥</span>'넥스트리온'은 개인정보
              보호를 위하여 관리자를 한정하여 그 수를 최소화하며 신용카드,
              은행계좌 등을 포함한 이용자의 개인정보의 분실, 도난, 유출,변조
              등으로 인한 이용자의 손해에 대하여 모든 책임을 집니다.
            </li>
            <li className={styles.ol_li}>
              <span className={styles.num}>⑦</span>'넥스트리온' 또는 그로부터
        ...
        <div className={styles.t_box}>
          ...
          <ol className={styles.ol}>
            <li className={styles.ol_li}>
              <span className={styles.num}>①</span>'넥스트리온'은 법령과 이
              약관이 금지하거나 공서양속에 반하는 행위를 하지 않습니다.
            </li>
            <li className={styles.ol_li}>
              <span className={styles.num}>②</span>'넥스트리온'은 이 약관이
              정하는 바에 따라 지속적이고, 안정적으로 재화·용역을 제공하는데
              최선을 다하여야 합니다.
            </li>
            <li className={styles.ol_li}>
              <span className={styles.num}>③</span>'넥스트리온'은 이용자가
              안전하게 인터넷 서비스를 이용할 수 있도록 이용자의
              개인정보(신용정보 포함)보호를 위한 보안 시스템을 갖추어야 합니다.
            </li>
            <li className={styles.ol_li}>
              <span className={styles.num}>④</span>'넥스트리온'이 상품이나
        ...
        <div className={styles.t_box}>
          ...
          <ol className={styles.ol}>
            ...
            <li className={styles.ol_li}>
              <span className={styles.num}>④</span>'넥스트리온' 기타 제3자의
              저작권 등 지적재산권에 대한 침해
            </li>
            <li className={styles.ol_li}>
              <span className={styles.num}>⑤</span>'넥스트리온' 기타 제3자의
        ...
        <div className={styles.t_box}>
          ...
          <ol className={styles.ol}>
            <li className={styles.ol_li}>
              <span className={styles.num}>①</span>'넥스트리온'은 연결사이트가
        ...
        <div className={styles.t_box}>
          ...
          <ol className={styles.ol}>
            ...
            <li className={styles.ol_li}>
              ...
              이용함으로써 얻은 정보를 넥스트리온의 사전 승낙없이 복제, 송신,
        ...
        <div className={styles.t_box}>
          ...
          <ol className={styles.ol}>
            ...
            <li className={styles.ol_li}>
              <span className={styles.num}>②</span>'넥스트리온'은 이용자로부터
            ...
            <li className={styles.ol_li}>
              <span className={styles.num}>④</span>'넥스트리온'과 이용자간에
